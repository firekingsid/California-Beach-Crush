...
//			GooglePlayServices.PlayServicesResolver.MenuResolve ();1.4.5
    ...
    void GUIInappSettings()
    {
        ...
        UnityInAppsIntegration iapManager = UnityInAppsIntegration.THIS;
        for (int i = 0; i < iapManager.IAP_Product_ID.Count; i++)
        {
            iapManager.IAP_Product_ID[i] = EditorGUILayout.TextField("Product id " + (i + 1), iapManager.IAP_Product_ID[i], new GUILayoutOption[] {
                GUILayout.Width (300),
    ...
    {
        UnityInAppsIntegration.THIS.IAP_Product_ID[0] = Application.identifier + ".gold1";
        UnityInAppsIntegration.THIS.IAP_Product_ID[1] = Application.identifier + ".gold2";
        UnityInAppsIntegration.THIS.IAP_Product_ID[2] = Application.identifier + ".gold3";
        UnityInAppsIntegration.THIS.IAP_Product_ID[3] = Application.identifier + ".gold4";
    }
    ...
    void GUIHelp()
    {
        GUILayout.Label("Juice Fresh game template - v 1.4.8", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(350) });
        GUILayout.Space(10);
