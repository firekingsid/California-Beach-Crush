...
public class FacebookManager : MonoBehaviour
{
...
#if PLAYFAB || GAMESPARKS
		GameSparksManager.Instance.SavePlayerData(userID, 0, LevelManager.Instance.currentLevel);
	...
	IEnumerator loadPicture(string url)//1.4.6
	{
		...
		Sprite sprite = Sprite.Create(texture, new Rect(0, 0, 128, 128), new Vector2(0, 0), 1f);
